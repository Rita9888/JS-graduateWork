...
var multiItemSlider = (function () {
  return function (selector, config) {
    var
      ...
      _sliderControlLeft = _mainElement.querySelector('.slider-control_left'), 
      _sliderControlRight = _mainElement.querySelector('.slider-control_right'), 
    ...
    var _controlClick = function (e) {
      if (e.target.classList.contains('slider-control')) {
        e.preventDefault();
        var direction = e.target.classList.contains('slider-control_right') ? 'right' : 'left';
...
var slider = multiItemSlider('.brandSlider')